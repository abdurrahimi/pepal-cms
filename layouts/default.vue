  ...
  export default {
    ...
    head() {
      return{
        ...
        script: [
          { src: 'https://ajax.googleapis.com/ajax/libs/jquery/3.6.1/jquery.min.js', defer:true },
          { src: 'https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/js/bootstrap.bundle.min.js', defer:true },
          { src: '/assets/vendor/apexcharts/apexcharts.min.js', defer:true },
          { src: '/assets/vendor/datatables/datatables.min.js', defer:true },
          { src: '/assets/vendor/datatables/dataTables.bootstrap5.min.js', defer:true },
          { src: '/assets/vendor/datatables/responsive.bootstrap5.min.js', defer:true },
